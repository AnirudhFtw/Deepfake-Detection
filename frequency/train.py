"""
Trains the frequency branch on processed/frequency/ (see pipeline/). Uses
the same shared video-level split as spatial/train.py.
"""
import os
import sys
...
BEST_SAVE_PATH = "../checkpoints/frequency_best.pth"
FINAL_SAVE_PATH = "../checkpoints/frequency_final.pth"
...
model = DeepfakeFrequencyCNN().to(DEVICE)
